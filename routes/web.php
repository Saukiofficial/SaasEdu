...
// ======================================================================
// 1. RUTE PUBLIK & AUTH (Bisa diakses dari Domain maupun Subdomain)
// ======================================================================
...
// ======================================================================
// 3. RUTE DOMAIN UTAMA (KHUSUS SUPER ADMIN & CUSTOMER)
// Contoh Akses: [kyysolutions.com/super-admin/tenants](https://kyysolutions.com/super-admin/tenants)
// ======================================================================
Route::domain($mainDomain)->middleware(['auth', 'verified'])->group(function () {
