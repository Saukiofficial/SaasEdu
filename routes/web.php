...
Route::middleware('auth')->group(function () {
    ...
    // ==========================================
    // TENANT ROUTES (TANPA DOMAIN WRAPPER)
    // ==========================================
    ...
    // Group Admin PPDB dengan Feature Override
    ...
    // Modul Keuangan dengan Feature Override
    ...
    // Modul LMS (E-Learning) dengan Feature Override
    ...
    // Modul CBT (Ujian) dengan Feature Override
